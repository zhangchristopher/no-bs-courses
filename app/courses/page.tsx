    ...
    <main className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <form action="/courses" method="get" className="mt-6 flex gap-2">
        <input
          ...
          className="w-full max-w-md rounded-lg border border-zinc-300 px-4 py-2 text-sm focus:border-zinc-500 focus:outline-none dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-50"
        />
        <button
          type="submit"
