      ...
      <div className="mx-auto flex max-w-5xl items-center gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
        ...
        <form action="/courses" method="get" className="relative hidden flex-1 max-w-xs sm:block">
          ...
          <input
            ...
            className="w-full rounded-full border border-zinc-200 bg-zinc-100 py-2 pl-9 pr-3 text-sm text-zinc-900 placeholder:text-zinc-500 focus:border-zinc-400 focus:bg-white focus:outline-none dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-50 dark:placeholder:text-zinc-500 dark:focus:border-zinc-600 dark:focus:bg-zinc-900"
          />
        ...
        <nav className="ml-auto flex items-center gap-5 text-sm">
          ...
          {session?.user ? (
            ...
            <>
              ...
              <Link
                href="/signup"
                className="rounded-full bg-zinc-900 px-4 py-1.5 font-medium text-white hover:bg-zinc-700 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200"
              >
                Sign up
              </Link>
            </>
